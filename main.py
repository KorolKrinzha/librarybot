...
def api_adduser():
    ...
    try:
        ...
        return Response(response='Пользователь успешно зарегистрирован', status=200)

    except Exception as e:
        print(e) 
        return Response(response='Ошибка при регистрировании пользователя', status=500)
...
# Проверка ответа на ивент пользователя
...
def api_userscore():
    ...
    try:
        ...
        return Response(response=userscore, status=200, mimetype='application/json')
    except:
